...
app.post("", async (req, res) => {
  ...
  if(question.length <= 100) {
    res.render('converter', {answer: ["Kindly enter your essay."], question: ""});
  } 
  else if(question) { // Only execute if question is not empty
